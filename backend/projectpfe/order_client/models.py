...
class Orderclient(models.Model):
    ...
    contract=models.ForeignKey(Contract,related_name='ordersclient',null=False,blank=False,on_delete=models.PROTECT)
    client=models.ForeignKey(Client,related_name='ordersclient',null=False,blank=False,on_delete=models.PROTECT)
