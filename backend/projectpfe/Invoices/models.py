...
class Invoice(models.Model):
    ...
    HT=models.DecimalField(decimal_places=2,max_digits=12,null=False,blank=False,default=Decimal('0'))
    TVA=models.DecimalField(decimal_places=2,max_digits=12,null=False,blank=False,default=Decimal('0'))
    TTC=models.DecimalField(decimal_places=2,max_digits=12,null=False,blank=False,default=Decimal('0'))
    
    
    
class InvoiceLineAllInfo(models.Model):
    id=models.AutoField(primary_key=True)
    invoice=models.ForeignKey(Invoice,related_name='invoice_InvoiceLineAllInfo_items',null=False,blank=False,on_delete=models.PROTECT)
    ...
    qte=models.DecimalField(decimal_places=2,max_digits=12,null=False,blank=False,default=Decimal('0'))
